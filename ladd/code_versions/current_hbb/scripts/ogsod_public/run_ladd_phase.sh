...

{
  ...
  echo "protocol_id=${PAPER_PROTOCOL_ID:-}"
  echo "task=${TASK}"
  echo "phase=${PHASE}"
  ...
  echo "fgd_impl=locked_fgd_yolo_gtbox_attention_20260618"
  echo "fgd_alpha=0.0001"
  echo "fgd_beta=0.00005"
  echo "fgd_gamma=0.001"
  echo "fgd_temperature=0.5"
  echo "fgd_mask_mode=gt_box"
  echo "fgd_relation=removed"
  echo "ld_impl=locked_ld_yolo_dfl_vlr_20260618"
  echo "ld_temperature=10.0"
  echo "ld_main_weight=0.25"
  echo "ld_vlr_weight=0.25"
  echo "ld_vlr_candidate=teacher_confidence_x_teacher_box_gt_iou"
