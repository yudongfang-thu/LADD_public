...
class TeacherStudentDecompositionKDNRRLTeacherUAuxTrainer(DetectionTrainer):
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides: dict | None = None, _callbacks: dict | None = None):
        ...
        self.dkd_cfg = {
            ...
            "fgd_alpha": float(overrides.pop("fgd_alpha", 1.0)),
            "fgd_beta": float(overrides.pop("fgd_beta", 0.5)),
            "fgd_gamma": float(overrides.pop("fgd_gamma", 1.0)),
            ...
            "ld_vlr_weight": float(overrides.pop("ld_vlr_weight", 1.0)),
            "ld_main_weight": float(overrides.pop("ld_main_weight", 1.0)),
