...
PROJECT_DIR="runs/cold_kd"
LOG_DIR="logs/cold_kd"
mkdir -p "$LOG_DIR"

RUN_NAME="sar_cold_kd_clean_t20_a2_l10_e300_b64_gpu${GPU_ID}_${RUN_TAG}"
...
PYTHONUNBUFFERED=1 python3 tools/train_cold_kd.py \
