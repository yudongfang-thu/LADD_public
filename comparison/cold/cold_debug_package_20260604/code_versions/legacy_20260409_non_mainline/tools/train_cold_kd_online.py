...
from cold_kd_online import OnlineCoLDOBBTrainer  # noqa: E402
from ultralytics import YOLO  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train an online CoLD baseline (trainable RGB teacher + SAR student) for YOLO11-OBB."
    )
    ...
    parser.add_argument(
        ...
        help="Trainable RGB teacher checkpoint.",
    )
    parser.add_argument("--lambda-kd", type=float, default=1.0)
    parser.add_argument("--lambda-cls-cold", type=float, default=1.0)
    ...
    parser.add_argument("--teacher-det-weight", type=float, default=0.1)
    ...
    parser.add_argument("--project", type=Path, default=REPO_ROOT / "runs" / "cold_kd_online")
    parser.add_argument("--name", default="sar_cold_kd_online_yolo11n_obb")
