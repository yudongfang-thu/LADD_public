...
注意：mosaic100 中 YOLO11n/YOLO11s 使用 `clean_a1b_dyn` dynamic LADD 作为临时 proxy，不是正式 Probe-A 主线；YOLO11m 未找到本地 dynamic proxy，暂保留已有 partial Probe-A。
...
|:-----------|:--------|:-----------------------------------------------------------------|:------------------------|:---------|:-------------|------------:|-------------------:|-------------------:|--------------------:|------------------:|----------------------------:|------------------------------:|--------------------------:|----------------------------:|----------------------:|:-------------------------------------------|
| no-mosaic  | YOLO11n | Probe-A clean_a1b_dynprobe                                       | no                      | complete | complete     |         800 |            0.55654 |            0.63018 |             0.57433 |               697 |                     0.01779 |                         24.16 |                   0.02067 |                       27.84 |               0.56415 | official complete no-mosaic Probe-A        |
| no-mosaic  | YOLO11s | Probe-A clean_a1b_dynprobe                                       | no                      | complete | complete     |         800 |            0.62897 |            0.65768 |             0.64073 |               640 |                     0.01176 |                         40.96 |                   0.02054 |                       56.63 |               0.62741 | official complete no-mosaic Probe-A        |
| no-mosaic  | YOLO11m | Probe-A clean_a1b_dynprobe                                       | no                      | complete | complete     |         800 |            0.6558  |            0.67909 |             0.66982 |               603 |                     0.01402 |                         60.2  |                   0.02023 |                       72.82 |               0.65275 | official complete no-mosaic Probe-A        |
...
| mosaic100  | YOLO11m | Probe-A clean_a1b_dynprobe partial; no local dynamic proxy found | no_dynamic_available    | partial  | partial_ref  |         493 |            0.65092 |            0.6734  |             0.6562  |               493 |                     0.00528 |                         23.49 |                   0.0261  |                       76.14 |               0.6562  | fallback partial Probe-A; not complete     |
...
| YOLO11m | Probe-A clean_a1b_dynprobe partial; no local dynamic proxy found | no_dynamic_available           | partial         |         0.01402 |             0.00528 |                           -0.00874 |                     60.2  |                         23.49 |                                -36.71 |
...
- mosaic100 dynamic proxy 只能用于判断趋势和是否值得补正式 Probe-A；不能直接进入论文主表。
