...
| LADD-clean / A1B 主方法定义 | [ladd_method_definition.md](ladd_method_definition.md) |
...
1. 当前 LADD 主方法口径已固定为 `LADD`：SAR baseline 初始化，A1 后直接进 B，B 阶段使用 dynamic teacher core + frozen reach probe，A2 只保留为历史诊断/消融
