...
"/root/shared-nvme/venvs/ladd312/bin/python" ladd/code/train_ladd_hbb.py \
  ...
  --patience 800 \
  --fraction 1.0 \
  --project runs_public/ogsod/hbb/yoloinit_dynamic_sweep_20260624/dynamic_kd0p5_yoloinit/yolo11n/seed0 \
  --name ogsod_yoloinit_dynamic_kd0p5_yoloinit_yolo11n_e800_b64_img256_s0_20260624_210844_gpu0 \
